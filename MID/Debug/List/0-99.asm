...
; 0000 0088 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 0089 DDRA = 0b11111111;
	LDI  R30,LOW(255)
	OUT  0x1A,R30
; 0000 008A DDRB = 0b11111111;
	OUT  0x17,R30
; 0000 008B while (1)
_0x4:
; 0000 008C {
...
; 0000 0094 {
; 0000 0095 
; 0000 0096 PORTB = 0b11111110;
	LDI  R30,LOW(254)
	OUT  0x18,R30
; 0000 0097 PORTA = arr[i];
	MOVW R30,R4
	RCALL SUBOPT_0x0
; 0000 0098 delay_ms(10);
; 0000 0099 PORTB = 0b11111101;
	LDI  R30,LOW(253)
	OUT  0x18,R30
; 0000 009A PORTA = arr[j];
	MOVW R30,R6
	RCALL SUBOPT_0x0
