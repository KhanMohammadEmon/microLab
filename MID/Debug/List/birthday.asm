...
_0x0:
	.DB  0x48,0x61,0x70,0x70,0x79,0x20,0x42,0x69
	.DB  0x72,0x74,0x68,0x64,0x61,0x79,0x0,0x45
	.DB  0x6D,0x6F,0x6E,0x0
_0x2000003:
	.DB  0x80,0xC0
...
_0x7:
	...
	BRLT _0x8
; 0000 009D {
; 0000 009E lcd_gotoxy(i,0);
	ST   -Y,R4
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 009F lcd_puts("Happy Birthday");
	__POINTW2MN _0x9,0
	RCALL SUBOPT_0x0
; 0000 00A0 delay_ms(1000);
; 0000 00A1 lcd_gotoxy(i,1);
	ST   -Y,R4
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
; 0000 00A2 lcd_puts("Emon");
	__POINTW2MN _0x9,15
	RCALL SUBOPT_0x0
