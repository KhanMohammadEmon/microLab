...
; 0000 0085 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 0086 
; 0000 0087 DDRA = 0b11111111;
	LDI  R30,LOW(255)
	OUT  0x1A,R30
; 0000 0088 DDRB = 0b11111111;
	OUT  0x17,R30
; 0000 0089 
; 0000 008A while (1)
_0x3:
; 0000 008B {
; 0000 008C PORTA = 0b11110111;
	LDI  R30,LOW(247)
	RCALL SUBOPT_0x0
; 0000 008D PORTB = 0b11011011;
; 0000 008E delay_ms(10);
; 0000 008F PORTA = 0b11111011;
	LDI  R30,LOW(251)
	OUT  0x1B,R30
; 0000 0090 PORTB = 0b10111111;
	LDI  R30,LOW(191)
	OUT  0x18,R30
; 0000 0091 delay_ms(10);
	...
	LDI  R27,0
	RCALL _delay_ms
; 0000 0092 PORTA = 0b11111101;
	LDI  R30,LOW(253)
	RCALL SUBOPT_0x0
; 0000 0093 PORTB = 0b11011011;
; 0000 0094 delay_ms(10);
; 0000 0095 PORTA = 0b11111100;
	LDI  R30,LOW(252)
	RCALL SUBOPT_0x0
; 0000 0096 PORTB = 0b11011011;
