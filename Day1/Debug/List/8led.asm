...
; 0000 0086 
; 0000 0087 
; 0000 0088 DDRC = 0b11111111;
	LDI  R30,LOW(255)
	OUT  0x14,R30
; 0000 0089 PORTC = 0b00000000;
	LDI  R30,LOW(0)
	OUT  0x15,R30
; 0000 008A 
; 0000 008B 
...
_0x3:
; 0000 008D {
; 0000 008E PORTC = 0b00000001;
	LDI  R30,LOW(1)
	RCALL SUBOPT_0x0
; 0000 008F delay_ms(100);
; 0000 0090 PORTC = 0b00000000;
; 0000 0091 PORTC = 0b00000010;
	LDI  R30,LOW(2)
	RCALL SUBOPT_0x0
; 0000 0092 delay_ms(100);
; 0000 0093 PORTC = 0b00000000;
; 0000 0094 PORTC = 0b00000100;
	LDI  R30,LOW(4)
	RCALL SUBOPT_0x0
; 0000 0095 delay_ms(100);
; 0000 0096 PORTC = 0b00000000;
; 0000 0097 PORTC = 0b00001000;
	LDI  R30,LOW(8)
	RCALL SUBOPT_0x0
; 0000 0098 delay_ms(100);
; 0000 0099 PORTC = 0b00000000;
; 0000 009A PORTC = 0b00010000;
	LDI  R30,LOW(16)
	RCALL SUBOPT_0x0
; 0000 009B delay_ms(100);
; 0000 009C PORTC = 0b00000000;
; 0000 009D PORTC = 0b00100000;
	LDI  R30,LOW(32)
	RCALL SUBOPT_0x0
; 0000 009E delay_ms(100);
; 0000 009F PORTC = 0b00000000;
; 0000 00A0 PORTC = 0b01000000;
	LDI  R30,LOW(64)
	RCALL SUBOPT_0x0
; 0000 00A1 delay_ms(100);
; 0000 00A2 PORTC = 0b00000000;
; 0000 00A3 PORTC = 0b10000000;
	LDI  R30,LOW(128)
	RCALL SUBOPT_0x0
; 0000 00A4 delay_ms(100);
; 0000 00A5 PORTC = 0b00000000;
; 0000 00A6 
; 0000 00A7 
; 0000 00A8 }
	RJMP _0x3
