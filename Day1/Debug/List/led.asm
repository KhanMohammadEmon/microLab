...
; 0000 008F PORTA = 0b00000000;
; 0000 0090 PORTA = 0b00000100;
	LDI  R30,LOW(4)
	RCALL SUBOPT_0x0
; 0000 0091 delay_ms(100);
; 0000 0092 PORTA = 0b00000000;
; 0000 0093 PORTA = 0b00001000;
	LDI  R30,LOW(8)
	RCALL SUBOPT_0x0
; 0000 0094 delay_ms(100);
; 0000 0095 PORTA = 0b00000000;
; 0000 0096 PORTA = 0b00010000;
	LDI  R30,LOW(16)
	RCALL SUBOPT_0x0
; 0000 0097 delay_ms(100);
; 0000 0098 PORTA = 0b00000000;
; 0000 0099 PORTA = 0b00100000;
	LDI  R30,LOW(32)
	RCALL SUBOPT_0x0
; 0000 009A delay_ms(100);
; 0000 009B PORTA = 0b00000000;
; 0000 009C PORTA = 0b01000000;
	LDI  R30,LOW(64)
	RCALL SUBOPT_0x0
; 0000 009D delay_ms(100);
; 0000 009E PORTA = 0b00000000;
; 0000 009F PORTA = 0b10000000;
	LDI  R30,LOW(128)
	OUT  0x1B,R30
